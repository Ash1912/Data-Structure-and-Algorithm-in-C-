/* How to represent a polynomial expression using 
linked list. Write program to add two polynomials.*/
...
poly *add_poly(poly *p1, poly *p2)
{
	...
	/*If poly2 has finished and some nodes are remaining in poly1*/
	while(p1 != NULL)
	{
		p3 = insert_poly_node(p3, p1->coef, p1->expo);
		p1 = p1->next;
